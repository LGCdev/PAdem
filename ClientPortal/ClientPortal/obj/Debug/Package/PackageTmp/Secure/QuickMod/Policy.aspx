    ...
    <p class="auto-style1">
        <asp:GridView ID="PayrollDataGV" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="ExposureID" DataSourceID="PayrollDataDS" ForeColor="Black" GridLines="Vertical" Width="1098px">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="PremiumAmt" DataFormatString="{0:c}" HeaderText="Premium" SortExpression="PremiumAmt" />
            </Columns>
    ...
    <p>
        <asp:GridView ID="LossDataGV" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="LossID" DataSourceID="LossDataDS" ForeColor="Black" GridLines="Vertical" Width="1144px">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="IncurredIndemnityAMT" DataFormatString="{0:c}" HeaderText="Incurred Indemnity" SortExpression="IncurredIndemnityAMT" />
                <asp:BoundField DataField="IncurredMedicalAmt" DataFormatString="{0:c}" HeaderText="Incurred Medical" SortExpression="IncurredMedicalAmt" />
                <asp:BoundField DataField="PaidIndemnityAmt" DataFormatString="{0:c}" HeaderText="Paid Indemnity" SortExpression="PaidIndemnityAmt" />
                <asp:BoundField DataField="PaidMedicalAmt" DataFormatString="{0:c}" HeaderText="Paid Medical" SortExpression="PaidMedicalAmt" />
            </Columns>
            <FooterStyle BackColor="#CCCC99" />
            <HeaderStyle BackColor="#6B696B" Font-Bold="True" ForeColor="White" />
            <PagerStyle BackColor="#F7F7DE" ForeColor="Black" HorizontalAlign="Right" />
        ...
        <asp:FormView ID="LossDataFV" runat="server" DataKeyNames="LossID" DataSourceID="LossDataDS" Visible="False">
            ...
            <ItemTemplate>
                ...
                <br />
                PaidIndemnityAmt:
                <asp:Label ID="PaidIndemnityAmtLabel" runat="server" Text='<%# Bind("PaidIndemnityAmt") %>' />
                <br />
                PaidMedicalAmt:
                <asp:Label ID="PaidMedicalAmtLabel" runat="server" Text='<%# Bind("PaidMedicalAmt") %>' />
                <br />
                <asp:LinkButton ID="EditButton" runat="server" CausesValidation="False" CommandName="Edit" Text="Edit" />
                &nbsp;<asp:LinkButton ID="DeleteButton" runat="server" CausesValidation="False" CommandName="Delete" Text="Delete" />
                &nbsp;<asp:LinkButton ID="NewButton" runat="server" CausesValidation="False" CommandName="New" Text="New" />
